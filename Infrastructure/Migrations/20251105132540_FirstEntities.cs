        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RadiusLogin = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Вход по SMS-коду", true, "SMS" },
                    { 2, "Аутентификация через RADIUS", true, "RADIUS" },
                    { 3, "Вход через социальную сеть VK", true, "VK" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthSessions_MacAddress",
                table: "AuthSessions",
                column: "MacAddress");
